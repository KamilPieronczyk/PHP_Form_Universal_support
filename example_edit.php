  ...
  <body>
    ...
    <form method="post">
      <fieldset class="form-group">
        ...
        <input type="text" name="text" class="form-control" id="exampleInputPassword1" value="<?php $form->get_value_e('text') ?>">
      </fieldset>
      <fieldset class="form-group">
        <label for="exampleInputPassword1">Password</label>
        <input type="text" name="nick" class="form-control" id="exampleInputPassword1" value="<?php $form->get_value_e('nick') ?>">
      </fieldset>
      <div class="checkbox">
        <label>
